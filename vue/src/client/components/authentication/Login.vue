            ...
            >
                ...
                >
                    <div
                        ...
                        class="flex; flex-row"
                    >
                        <p>Nie pamiętasz hasła? <a class="font-bold" href="http://localhost:8080/client/passwordresetemailsend">Zresetuj hasło</a></p>
                        <p>Nie masz konta? <a class="font-bold" href="http://localhost:8080/client/register">Zarejestruj się</a></p>
                    </div>
                </div>
                <div
                    class="flexible"
